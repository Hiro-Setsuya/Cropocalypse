...
class Game:
    ...
    def draw_pause_screen(self):
        ...
        scaled_width = int(screen_width * 0.4)
        scaled_height = int(screen_height * 0.99)
        ...
        quit_button_width, quit_button_height = 300, 150  # Increased height from 100 to 150
        quit_button_x = (screen_width - quit_button_width) // 2
        quit_button_y = screen_height // 2 + 100  # Place it below the pause background
        quit_button_rect = pygame.Rect(quit_button_x, quit_button_y, quit_button_width, quit_button_height)
        ...
        resume_button_y = screen_height // 2 - 120  # Moved it slightly lower (adjusted from -200 to -150)
    ...
    def update_play_button_position(self):
        ...
        if self.fullscreen:
            ...
            self.button_x = self.screedn.get_width() / 2 - 100  # Centered horizontally
            self.button_y = self.screen.get_height() / 2 + 100  # Centered vertically (a bit lower)
        else:
